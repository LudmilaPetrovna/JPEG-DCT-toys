...
./dct_freqs $SIDE | ffmpeg -v 0 -f rawvideo -s $SIZE -pix_fmt gray -i - -y freqs-$SIZE-%02d.bmp
montage -background green -geometry $SIZE+1+1 -tile 8x freqs-$SIZE-*.png freqs-pano-$SIZE.png
